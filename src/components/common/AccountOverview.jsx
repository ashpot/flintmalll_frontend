  ...
  <div className="bg-white p-6 rounded-2xl shadow-sm">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="bg-[#E5F9FE] p-5 rounded-lg text-center space-y-3">
        ...
        <p className="text-2xl md:text-4xl font-bold text-[#285386]"> 24 {/*stats.activeAds*/}</p>
      ...
      <div className="bg-[#E9FAF1] p-5 rounded-lg text-center space-y-3">
        ...
        <p className="text-2xl md:text-4xl font-bold text-[#0DAC4F]">3000 {/*stats.totalViews*/}</p>
      ...
      <div className="bg-[#FDF4E1] p-5 rounded-lg text-center space-y-3">
        ...
        <p className="text-2xl md:text-4xl font-bold text-[#C99507]">2025 {/*stats.memberSince*/}</p>
