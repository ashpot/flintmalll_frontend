  ...
  return (
    <header className="bg-white shadow-sm py-6 px-7 flex justify-between items-center border-b border-[#E5E5E5] flex-shrink-0">
      ...
      <div className="flex items-center gap-6">
        ...
        >
          {/* No profile photo field returned by login/register — falls back to placeholder until backend adds one */}
          <img
            src={UserAvatar}
            alt="Admin Avatar"
          ...
          />
          <div>
            <h4 className="font-semibold text-sm text-gray-900 group-hover:text-secondary transition-colors duration-150">
