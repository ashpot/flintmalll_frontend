...
const ReportedAds = () => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm">
      ...
      {/* <div className="mt-6 border border-yellow-300 bg-yellow-50 p-4 rounded-lg">
        <p className="text-sm text-yellow-800 font-medium">
          Not connected yet — the backend doesn't currently expose a reported-ads
          status or endpoint. This will be wired up once that's added.
        </p>
      </div> */}
    </div>
  );
