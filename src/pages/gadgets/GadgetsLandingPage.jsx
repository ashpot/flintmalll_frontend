	...
	<div>
		<Navbar 
			rightContent={
				...
				My Account
				<button className='flex items-center gap-3 bg-secondary text-white px-3 py-2 font-medium text-lg rounded-2xl'><TbTag size={20} /> Post Ad</button>
				</div>
			}
		/>
		<div className='mt-10'>
			<p className='w-[85%] mx-auto mb-5 text-lg font-medium'>Home/Gadgets </p>
			<CategoryCarousel title="Gadget Categories" categories={categories} />
			<div className="space-y-10 mb-10">
				<AdSection title="Premium Ads" ads={premiumAds} />
				<AdSection title="Recent Ads" ads={recentAds} />
			</div>
		</div>
...
export default GadgetsLandingPage
